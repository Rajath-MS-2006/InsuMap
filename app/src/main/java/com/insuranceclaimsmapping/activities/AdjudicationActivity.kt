        ...
        lifecycleScope.launch {
            ...
            for (claim in claims) {
                try {
                    ...
                    val serviceName = if (claim.items.isNotEmpty()) claim.items.joinToString(", ") { it.description } else claim.description
                    updateLog("[Rules] Checking policy coverage for items...")
                    binding.tvAdjudicationStatus.text = "Checking coverage for items..."
                    delay(500)
