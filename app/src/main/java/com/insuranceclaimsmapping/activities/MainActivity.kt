    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        when (role) {
            ...
            "INSURER" -> {
                ...
                dashboardItems.add(DashboardItem(4, "View Claims History", R.drawable.ic_history, "INSURER"))
                dashboardItems.add(DashboardItem(5, "Insurer Profile", R.drawable.ic_profile, "INSURER"))
            }
        }
